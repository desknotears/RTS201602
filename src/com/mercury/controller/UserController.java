...
//				+ "! Successfully change your password!");
	...
	@RequestMapping(value = "/member/paidOrder", method = RequestMethod.GET)
	public ModelAndView memberOrder() {
		ModelAndView mav = new ModelAndView();
		mav.setViewName("/member/paidOrder");
		return mav;
	}
	
	
	@RequestMapping(value = "/member/unpaidOrder", method=RequestMethod.GET)
	public ModelAndView memberOrderUnpaid(){
		ModelAndView mav = new ModelAndView();
		mav.setViewName("/member/unpaidOrder");
		return mav;
	}

	
	@RequestMapping(value = "/member/cancelledOrder", method=RequestMethod.GET)
	public ModelAndView memberOrderCancelled(){
		ModelAndView mav = new ModelAndView();
		mav.setViewName("/member/cancelledOrder");
		return mav;
	}
	...
	/**************************RTS201602*************************************/
	@RequestMapping(value = "/login2016", method = {RequestMethod.GET,RequestMethod.POST})
