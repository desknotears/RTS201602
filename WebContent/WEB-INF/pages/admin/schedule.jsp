			...
			url : "/MyRTS/admin/scheduleData",
				...
				function(data) {
					...
					for (var i = 0; i < $scope.scheduleData.length; i++) {
						$scope.scheduleData[i].date = formatDate(new Date(
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="panel panel-default">
						<div class="panel-heading">Schedule Tables</div>
						<div class="panel-body">
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover"
									...
									<tr ng-repeat="x in scheduleData">
										<th>{{x.train.trainNo}}</th>
										<th>{{x.date}}</th>
										<th>{{(x.train.totalTicketQty) - (x.availableTickets)}}</th>
										<th>{{x.availableTickets}}</th>
										<th>{{x.train.totalTicketQty}}</th>
									</tr>
								</table>
							</div>
